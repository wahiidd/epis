...
export const GameContextAPI = createContext();

const initialState = {
  currentScreen: 'home', // home, mode, game, podium
  mode: null, // 'solo' or 'team'
  players: [],
  ...
  awaitingAnswer: false // Flag to pause turn until answer submitted
  ,
  lastPositions: {}
};
  ...
  switch (action.type) {
    ...
    case 'REVERT_POSITION':
      ...
      return {
        ...
        // Don't delete lastPositions - keep it in case revert is called multiple times
      };
    case 'UPDATE_SCORE': {
      const updatedPlayers = [...state.players];
      const idx = action.payload.playerIndex;
      const existing = updatedPlayers[idx] || {};
      updatedPlayers[idx] = {
        ...existing,
    ...
    case 'START_GAME':
      // Initialize playerPositions for all players (start at position 0)
